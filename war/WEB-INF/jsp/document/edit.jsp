...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title><c:out value="${resource.filename}" /></title>
		<jsp:include page="../includes/head.inc.jsp"/>
    </head>
    <body>
		<jsp:include page="../includes/top.inc.jsp"/>
		<form action="${resource.filename}.doc.jwa" method="POST">
		<textarea rows="40" cols="60" style="height:100%; width:100%;">${resource.absolutePath}</textarea><br />
