 ...
 *
 * Copyright (c) 2007 Staffan Olsson (www.repos.se)
 * May contain customer specific extensions.
 *
 * Contains jQuery - New Wave Javascript
 ...
 * @version $Id: repos.js 3861 2008-04-30 16:15:03Z solsson $
 */
var Repos = {};
...
Repos.service('index/', function() {
	...
	if (m) {
		...
		$('.contentcommands').append(
			'<a class="action" href="'+Repos.webapp+'edit/file/?target='
			+encodeURIComponent(Repos.target)+'&suggestname='
			+''+'.testcase.txt">Add&nbsp;testcase</a>');
