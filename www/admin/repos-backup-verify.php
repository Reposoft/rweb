...
# This is a ported bash shell script, syntax has been preserved
...
//FILEPREFIX="$2"
$FILEPREFIX='srv-repos-staffan';
// repository to load to
$REPO='/srv/repos/staffan'
...
if ( strlen("$BACKUPDIR") * strlen("$FILEPREFIX") == 0 ) {
//then
	echo "Usage: php repos-backup-verify '/path/to/files' 'file-prefix-'";
	exit 1;
}
