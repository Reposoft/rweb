...
#    log
TO="../log"
cp "${sfrom}/actions/2leftarrow.png" "$TO/_copiedfrom.png"
cp "${sfrom}/actions/fileopen.png" "$TO/_m.png"
cp "${sfrom}/actions/attach.png" "$TO/_a.png"
cp "${sfrom}/actions/textblock.png" "$TO/_message.png"
cp "${sfrom}/apps/db.png" "$TO/_d.png"