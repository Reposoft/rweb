...
public class ValidationRuleImplTest {

	public static junit.framework.Test suite() { 
	    return new JUnit4TestAdapter(ValidationRuleImplTest.class); 
	}	
	...
	@Test public void testValid() {
		...
		replay(strategyMock);
		// do the test
		ValidationRule<Object> validationRule = new ValidationRuleImpl<Object>(strategyMock);
