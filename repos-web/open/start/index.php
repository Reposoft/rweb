...
if (!$acl || !is_file($acl)) {
	...
	trigger_error("This user account must use a folder URL in order to access Subversion. Repository listing is disallowed and project access rules are unknown.", E_USER_NOTICE);
} else {
